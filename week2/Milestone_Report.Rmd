...
I will need to work on the data preprocessing to speed up the proccess.  I am planning to get a list of 100,000 most frequent n-grams from each of the data sets generated to reduce the file size.  I will use files containing 100,000 n-grams for the actual application.