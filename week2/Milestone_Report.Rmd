...
The code below shows the basic stats about the files and object loaded.  I employed simple **wc** command to display the number of lines, words, and characters in each file.  I confirm the line counts by displaying line count of loaded data sets.  The code is documented providing detailed explanation of the activities performed in the code. 
...
The purpose of the code below is to create TermDocumentMatrix objects for unigrams, bigrams, trigrams, and fourgrams.  Once TermDocumentMatrix is created, convert TermDocumentMatrix objects corresponding to n-grams into data frames containing two fields: item and Frequency, where item is an actual word and Frequency is the frequency of the word in the combined data set.  The code is documented providing detailed explanation of the activities performed in the code.
...
However, this is just a plan.  I may use alternative approach based more on statistics rather than on text searchers.

# References

1. [R and Data Science Reference] [https://github.com/lgreski/datasciencectacontent], last accessed 03/11/2016
2. [Survival Guied to Data Science with R] [http://togaware.com/onepager/], last accessed 03/11/2015
3. [Presentation by M. H. Nierhoff] [https://rpubs.com/nierhoff/cdsc], last accessed 03/11/2015
